...
const ArticalItem = ({
  ...
  const unLikeIcon = (
    <svg className={style.unLikeIcon} width='20' height='18' viewBox='0 0 20 18' fill='none'>
      <path
  ...
  const FavNormalIcon = (
    <svg className={style.saveNormal} width='16' height='20' viewBox='0 0 16 20' fill='none'>
      <path
      ...
      <div className={style.item}>
        ...
        <div className={style.itemOption}>
          ...
          <div className={style.share} onClick={() => handleShare(true)}>
            ...
            <svg className={style.shareHover} width='20' height='14' viewBox='0 0 20 14'>
              <path
          ...
          {shareShow && <Share handleShare={handleShare} id={id} image={image} title={title} />}
        </div>
      </div>
    </div>
  )
